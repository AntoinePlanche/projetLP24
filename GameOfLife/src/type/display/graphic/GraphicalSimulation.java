...
public class GraphicalSimulation extends JFrame implements ActionListener {
    ...
    public void startSimulation(int line, int column)
    {
        ...
        JOptionPane.showMessageDialog(this, RESOURCEBUNDLE.getString("keygraphicthree"), "Configuration", JOptionPane.INFORMATION_MESSAGE);
    ...
    public void actionPerformed(ActionEvent e)
	{
		...
		if ( e.getSource() == startSimulation )
        {
			...
			NbrSecondBetweenLap = 1000*Float.parseFloat(JOptionPane.showInputDialog(this,RESOURCEBUNDLE.getString("keygraphicnine"), RESOURCEBUNDLE.getString("keygraphicten"), JOptionPane.QUESTION_MESSAGE));
    		...
    		while ( !isInterrupted())  // As long as the thread is not interrupted ...
    		{
    			...
    			try
    				...
    				synchronized(this)
    					...
    					while (!continuer && !finish) wait(); // To put the thread in pause
    			...
    			if( finish ) break; // to stop the thread
