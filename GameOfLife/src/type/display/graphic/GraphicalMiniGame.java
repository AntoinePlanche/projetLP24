...
public class GraphicalMiniGame extends JFrame implements ActionListener {
	...
	public void startSimulation(int line, int column) throws IOException
	{
		...
		JOptionPane.showMessageDialog(this, RESOURCEBUNDLE.getString("keygraphicminigamesix"), "Configuration",
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if ( e.getSource() == startPlayerConfiguration )
		{
			...
			goalLap = Integer
					.parseInt(JOptionPane.showInputDialog(this, RESOURCEBUNDLE.getString("keygraphicminigameseven"),
							RESOURCEBUNDLE.getString("keygraphicminigameeight"), JOptionPane.QUESTION_MESSAGE));

			while ( goalLap < 1 ) // verification loop
			{

				JOptionPane.showMessageDialog(this, RESOURCEBUNDLE.getString("keygraphicminigamenine"),
			...
			JOptionPane.showMessageDialog(this, RESOURCEBUNDLE.getString("keygraphicminigameeleven"), "Configuration",
					JOptionPane.INFORMATION_MESSAGE);
		...
		else if ( e.getSource() == startMiniGame )
		{
			...
			JOptionPane.showMessageDialog(this, RESOURCEBUNDLE.getString("keygraphicminigametwelve"),
					RESOURCEBUNDLE.getString("keygraphicminigamethirteen"), JOptionPane.INFORMATION_MESSAGE);

			// The player choose his level of difficulty

			String[] levelOfDifficulty = { RESOURCEBUNDLE.getString("keygraphicminigamefourteen"),
					RESOURCEBUNDLE.getString("keygraphicminigamefifteen") };
			difficulty = (byte) JOptionPane.showOptionDialog(this,
					RESOURCEBUNDLE.getString("keygraphicminigamesixteen"),
					RESOURCEBUNDLE.getString("keygraphicminigamethirteen"), JOptionPane.YES_NO_CANCEL_OPTION,
					JOptionPane.QUESTION_MESSAGE, null, levelOfDifficulty, levelOfDifficulty[1]);
