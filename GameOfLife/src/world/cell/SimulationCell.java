...
public class SimulationCell {
	...
	/*
	 * two color, updating for the updating tour, current for the current tour. Indeed during the execution of the program the cells already updated will
	 * influence those not yet updated. That is why we need two colors one to save results and one to apply the algorithm
	 */
